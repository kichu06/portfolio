  ...
  const projects = [
    {
      ...
      description:
        "A Retrieval-Augmented Generation (RAG) application that allows users to upload PDF documents and ask questions using semantic search, vector databases, and Large Language Models.",
      tech: [
        "Python",
        "Streamlit",
        "ChromaDB",
      ...
      demoLink:
        "https://rag-document-assistant-twnpiyqkcbmqvqynh2nopb.streamlit.app/",
      githubLink:
        "https://github.com/kichu06/rag-document-assistant"
    },
    {
